      ...
      >
        <Stack spacing="jumbo">
          <Stack spacing="medium">
            <Heading fontSize="header5" fontWeight="normal">
              Job Details
            </Heading>

            <Stack>
              <Heading as="h1" fontSize="header4">
                Marketing Manager
              </Heading>
              <HStack>
          ...
          <Stack>
            <Heading fontSize="header5">Job Overview</Heading>
            <Text>
          ...
          <Stack>
            <Heading fontSize="header5">Requirements</Heading>
            <UnorderedList>
              <ListItem>
          ...
          <Stack>
            <Heading fontSize="header5">Responsibilities</Heading>
            <UnorderedList>
              <ListItem>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit.
              </ListItem>
