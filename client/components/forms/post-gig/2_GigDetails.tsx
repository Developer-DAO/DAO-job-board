...
export default function GigDetails({
  ...
  const { gigcategory, gigreward, gigamount, gigtimeframe } = formData;
    ...
    <>
      <Container textAlign="center" mt="2.5%" mb="2.5%">
        ...
        <Text color="black" as="i">
          Define your project timeframe, category, and reward
        </Text>
      </Container>

      <Container maxW="100%">
        <Heading mb="5px" color="black" fontSize="md" textAlign="left">
          Pick a gig keyword category
        </Heading>
        ...
        <Heading mb="5px" color="black" fontSize="md" textAlign="left">
          Explain reward method (optional)
        </Heading>
        <Select
          name="gigreward"
          value={gigreward}
