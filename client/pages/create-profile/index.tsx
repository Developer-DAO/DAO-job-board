...
Accordion } from "@chakra-ui/react";

import {ButtonBlack, ButtonGreen, ButtonRed} from "../../styles/ui-components/Chakra-Button";
  ...
  return (
    ...
    >
      ...
      >
          ...
          <Heading
          mt="5%"
          size="md">Content Visibility</Heading>
          <Text  mt="2.5%" fontSize="xs">Choose what you want people to see on your profile</Text>
      ...
      >
        ...
        <Text fontSize="xs">Keywords help categorize your profile in skills and sectors</Text>
        <ButtonBlack>
          Choose Keywords
        </ButtonBlack>
